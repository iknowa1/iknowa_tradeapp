...
class HeaderTextFormField extends StatefulWidget {
  ...
  final bool? isHeaderSuffixItem;
  final String? headerSuffixIcon;
  ...
  @override
  State<HeaderTextFormField> createState() => _BaseTextFormFieldState();
}

class _BaseTextFormFieldState extends State<HeaderTextFormField> {
            ...
            children: [
              Row(
                children: [
                  ...
                  if (widget.isOptional!) Text(AppString.optional, style: AppFonts.regular(10, AppColors.textDarkGray.withOpacity(0.5))),
                  if (widget.isRequired) Text('*', style: TextStyle(color: widget.starColor)),
                ],
              ),
              if (widget.isHeaderSuffixItem!) SvgPicture.asset(widget.headerSuffixIcon!)
            ],
          ),
                  ...
                  ? InkWell(
                      ...
                      child: Container(
                        ...
                        child: SvgPicture.asset(
                          widget.suffixIcon!,
                          colorFilter: ColorFilter.mode(widget.suffixIconColor != null ? widget.suffixIconColor! : const Color(0xFF9C9C9C), BlendMode.srcIn),
                        ),
                      ),
                    )
                  : Container(),
