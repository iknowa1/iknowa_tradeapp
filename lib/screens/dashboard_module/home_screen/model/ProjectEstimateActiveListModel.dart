class ProjectEstimateActiveListModel {
  int? id;
  String? refId;
  String? name;
  String? postcode;
  ...
  List<dynamic>? projectRating;
  List<dynamic>? projectEstimation;

  ProjectEstimateActiveListModel(
      {this.id,
      this.refId,
      this.name,
      this.postcode,
      ...
      this.latitude,
      this.longitude,
      this.projectJobStatus,
      this.categories,
      this.projectProperties,
      this.userWorkstation,
      this.projectRating,
      this.projectEstimation});

  ProjectEstimateActiveListModel.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    refId = json['refId'];
    name = json['name'];
    ...
    projectJobStatus = json['projectJobStatus'] != null ? new ProjectJobStatus.fromJson(json['projectJobStatus']) : null;
    // if (json['categories'] != null) {
    //   categories = <Null>[];
    //   json['categories'].forEach((v) {
    //     categories!.add(new dynamic.fromJson(v));
    //   });
    // }
    ...
    // if (json['projectRating'] != null) {
    //   projectRating = <Null>[];
    //   json['projectRating'].forEach((v) {
    //     projectRating!.add(new Null.fromJson(v));
    //   });
    // }
    // if (json['projectEstimation'] != null) {
    //   projectEstimation = <Null>[];
    //   json['projectEstimation'].forEach((v) {
    //     projectEstimation!.add(new Null.fromJson(v));
    //   });
    // }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.projectJobStatus != null) {
      data['projectJobStatus'] = this.projectJobStatus!.toJson();
    }
    ...
    if (this.projectRating != null) {
      data['projectRating'] = this.projectRating!.map((v) => v.toJson()).toList();
    }
    if (this.projectEstimation != null) {
      data['projectEstimation'] = this.projectEstimation!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}

class ProjectJobStatus {
  String? id;
  String? status;
  String? display;
  String? dateCreated;
  ...
  ProjectJobStatus({this.id, this.status, this.display, this.dateCreated, this.dateUpdated, this.dateDeleted});

  ProjectJobStatus.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    status = json['status'];
