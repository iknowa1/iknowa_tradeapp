...
//                   ),
//                   onSelect: (date) {
//                     if (date.withoutTime.withoutTime.isBefore(_startDate.withoutTime)) {
...
//                   onSelect: (date) {
//                     if (_endTime != null && date.getTotalMinutes > _endTime!.getTotalMinutes) {
...
//                   onSelect: (date) {
//                     if (_startTime != null && date.getTotalMinutes < _startTime!.getTotalMinutes) {
//                       ScaffoldMessenger.of(context).showSnackBar(SnackBar(
