...
class SetPasscodeScreen extends GetView<SetPasscodeController> {
                    ...
                    child: IgnorePointer(
                      child: OTPTextField(
                        ...
                        onChanged: (code) {
                          ...
                          if (code.length == 4) {
                            Dialogs.materialDialog(msg: 'Are you sure want to save this password?', title: "Alert", color: Colors.white, context: context, actions: [
                              IconsOutlineButton(
                                onPressed: () {
                                  Get.back();
                                },
